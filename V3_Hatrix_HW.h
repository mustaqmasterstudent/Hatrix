...
const structGPIO GPOA7    = { 7    , LOCATION_EXTERNAL , 0x20       } ; // GPOA7 // This does not have ground pin together, right. Only used if the ground is used along with this pin. (Maybe having ground externally or something similar to that.)
const structGPIO GPOB7    = { 15   , LOCATION_EXTERNAL , 0x20       } ; // GPOB7 // This does not have ground pin together, right. Only used if the ground is used along with this pin. (Maybe having ground externally or something similar to that.)
...
const structBoardAddressPins BoardAddress = {{  8  ,  9  ,  10  ,  11  ,  12  ,  13  ,  14  }, {LOCATION_EXTERNAL, LOCATION_EXTERNAL, LOCATION_EXTERNAL, LOCATION_EXTERNAL, LOCATION_EXTERNAL, LOCATION_EXTERNAL, LOCATION_EXTERNAL}, {    0x20    ,    0x20    ,    0x20    ,      0x20    ,    0x20     ,     0x20    ,       0x20    }}; // BoardAddress
