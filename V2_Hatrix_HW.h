...
const structPWM PWM_1 = {  PA8  ,     PB1     ,    PB0    ,     EMPTY_DATA    ,  3300 , 1024 , LOCATION_INTERNAL , LOCATION_INTERNAL , LOCATION_INTERNAL , LOCATION_EXTERNAL ,   EMPTY_DATA   ,     EMPTY_DATA     ,     EMPTY_DATA    ,     0X40    ,        2000      ,          EMPTY_DATA     ,         10000         }; // PWM_1
const structPWM PWM_2 = {  PA6  ,     PA7     ,    PA5    ,     EMPTY_DATA    ,  3300 , 1024 , LOCATION_INTERNAL , LOCATION_INTERNAL , LOCATION_INTERNAL , LOCATION_EXTERNAL ,   EMPTY_DATA   ,     EMPTY_DATA     ,     EMPTY_DATA    ,     0X42    ,        2000      ,          EMPTY_DATA     ,         10000         }; // PWM_2
...
const structBoardAddressPins BoardAddress = {{ PB12 , PB13 , PB14 , EMPTY_DATA, EMPTY_DATA, EMPTY_DATA, EMPTY_DATA}, {LOCATION_INTERNAL, LOCATION_INTERNAL, LOCATION_INTERNAL, LOCATION_INTERNAL, LOCATION_INTERNAL, LOCATION_INTERNAL, LOCATION_INTERNAL}, { EMPTY_DATA ,  EMPTY_DATA ,  EMPTY_DATA ,  EMPTY_DATA ,  EMPTY_DATA ,  EMPTY_DATA ,  EMPTY_DATA  }};
